...
def HXRSS_singleLine(gid,pitch_angle_list,roll_angle_list,dthp,dthy,dthr,alpha):
    ...
    def plotene(thplist,fact,n,h,k,l,a,DTHP,thylist,thr,n0,pitchax,rollax,yawax):
        eevlist = [(phev(fact,1,h,k,l,a,thp-np.deg2rad(DTHP),thy,thr,n0,pitchax,rollax,yawax))   for thp, thy in zip(thplist/180*np.pi, thylist)] #0.98695
